...
try {
  ...
  try {
    ExcelJS = require('./load-tests/node_modules/exceljs');
  } catch (e2) {
...
async function generateSecurityReviewExcel() {
  ...
  console.log(`\n✅ Security Review Excel Sheet Successfully Generated at:\n${outPath}`);
}

generateSecurityReviewExcel().catch((err) => console.error('Excel Generation Error:', err));
